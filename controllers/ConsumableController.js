...
exports.getAllItems = async (req, res) => {
  try {
    ...
    const items = await ConsumableItem.find(filter).sort({ createdAt: -1 });
...
exports.addTransaction = async (req, res) => {
  try {
    ...
    const transaction = await ConsumableTransaction.create({
...
exports.getItemTransactions = async (req, res) => {
  try {
    ...
    const transactions = await ConsumableTransaction.find({ itemId: req.params.itemId })
